...
pub fn push_elements_from_surface_tree<R, C>(
    renderer: &mut R,
    surface: &WlSurface,
    ...
    R: Renderer + ImportAll + NiriRenderer,
    C: PushRenderElement<WaylandSurfaceRenderElement<R>, R>,
{
            ...
            if let Some(data) = data {
                ...
                if has_view {
                    match WaylandSurfaceRenderElement::from_surface(
                        ...
                        Ok(Some(surface)) => collector.push_element(surface),
