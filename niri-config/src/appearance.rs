...
impl MergeWith<BlurRule> for Blur {
    fn merge_with(&mut self, part: &BlurRule) {
        ...
        merge_clone!((self, part), passes, radius, noise, brightness, contrast, saturation, ignore_alpha, x_ray);
    }
}
...
impl MergeWith<Self> for BlurRule {
    fn merge_with(&mut self, part: &Self) {
        ...
        merge_clone_opt!((self, part), passes, radius, noise, brightness, contrast, saturation, ignore_alpha, x_ray);
    }
}
